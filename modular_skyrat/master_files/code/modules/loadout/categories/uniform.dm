...
/datum/loadout_item/uniform/jumpsuit/security_skirt
	...
	restricted_roles = list(JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_HEAD_OF_SECURITY, JOB_SECURITY_MEDIC) //BUBBER EDIT: adds JOB_SECURITY_MEDIC
...
/datum/loadout_item/uniform/jumpsuit/imperial_police_uniform
	...
	restricted_roles = list(JOB_WARDEN, JOB_DETECTIVE, JOB_SECURITY_OFFICER, JOB_HEAD_OF_SECURITY, JOB_SECURITY_MEDIC)
...
/datum/loadout_item/uniform/jumpsuit/utility_sec
	...
	restricted_roles = list(JOB_SECURITY_OFFICER, JOB_DETECTIVE, JOB_WARDEN, JOB_BLUESHIELD, JOB_HEAD_OF_SECURITY)
