...
/datum/job/barber
	alternate_titles = list(JOB_BARBER_RU,)

/datum/job/blueshield
	alternate_titles = list(JOB_BLUESHIELD_RU,)

/datum/job/nanotrasen_consultant
	alternate_titles = list(JOB_NT_REP_RU,)

/datum/job/security_medic
	alternate_titles = list(JOB_SECURITY_MEDIC_RU,)

/datum/job/telecomms_specialist
	alternate_titles = list(JOB_TELECOMMS_SPECIALIST_RU,)

/datum/job/blacksmith
	alternate_titles = list(JOB_BLACKSMITH_RU,)
