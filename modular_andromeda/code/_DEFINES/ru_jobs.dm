/// Синхронизируйте это с JOBS_RU из tgui\packages\tgui\andromeda\ru_jobs.tsx
...
#define JOB_NT_REP_RU "Представитель Нанотразен"
#define JOB_BLUESHIELD_RU "Синий Щит"
...
#define JOB_VETERAN_ADVISOR_RU "Ветеран"
/// Кибернетика
#define JOB_AI_RU "ИИ"
...
#define JOB_SECURITY_MEDIC_RU "Военный Врач"
...
#define JOB_TELECOMMS_SPECIALIST_RU "Специалист Телекоммуникаций"
/// Медицина
...
GLOBAL_LIST_INIT(job_titles_ru, list(
	...
	JOB_SECURITY_MEDIC = JOB_SECURITY_MEDIC_RU,
	...
	JOB_TELECOMMS_SPECIALIST = JOB_TELECOMMS_SPECIALIST_RU,
	/// Медицина
