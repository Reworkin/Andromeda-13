/obj/item/jukebox
	...
	icon = 'modular_andromeda/icons/obj/boombox.dmi'
	righthand_file = 'modular_andromeda/icons/obj/boombox_righthand.dmi'
	lefthand_file = 'modular_andromeda/icons/obj/boombox_lefthand.dmi'
	verb_say = "states"
