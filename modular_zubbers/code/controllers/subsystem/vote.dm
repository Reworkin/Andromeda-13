...
/datum/controller/subsystem/vote/fire()
	...
	for(var/client/late_voter as anything in GLOB.clients)
		...
		to_chat(late_voter, vote_font(fieldset_block("Режим игры", "It's time to make your choices! Type 'vote' or click <a href='byond://winset?command=vote'>here</a> to place your votes.", "boxed_message purple_box")))
